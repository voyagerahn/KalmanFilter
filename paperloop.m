...
% of instantaneous height and speed for the hypothetical 
% falling paper wad as discussed in Chapter 5. 
% 
...
z = zvect; 
% Set up vectors to store selected elements of xA and PA 
% from all iterations 
